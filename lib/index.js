...
module.exports = React.createClass({
	...
	getOptionsFromProps: function (nextProps) {
		var options, props = nextProps || this.props;
	...
	componentWillReceiveProps: function(nextProps) {
		if (this.$picker) {
			this.removeDateRangePicker();
			this.initializeDateRangePicker(nextProps);
		}
	},
	removeDateRangePicker: function() {
		this.$picker.data('daterangepicker').remove();
	},
	initializeDateRangePicker: function(nextProps) {
		var $this = this;
		...
		// initialize
		$this.$picker.daterangepicker(this.getOptionsFromProps(nextProps));
